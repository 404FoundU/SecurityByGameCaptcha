<!-- begin #content -->
		...
		<div id="content" class="content">
			<h1 class="page-header">Project <small>Sudoku/Rubis</small></h1>
			<!-- end page-header -->
                            ...
                            <form class="form-horizontal form-bordered" method="post" action="processes/validate.php">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										...
										<br><br><p style="font-size:10px">New to Sudoku/Rubis Project? <a href="register.php">Sign up</a> for an account</p>
									</div>
								</div>	
                            </form>
                        </div>
